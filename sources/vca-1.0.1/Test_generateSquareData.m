function [varargout] = Test_generateSquareData(varargin)
%Test_generateSquareData Generates a data set of cicle components
%   
%   Generates a set of points distibuted over several circular components.
% 
% USAGE:
%   Sm = Test_generateSquareData(N, K, d, r)
%
% INPUTS:
%   N - number of data
%   K - number of lines
